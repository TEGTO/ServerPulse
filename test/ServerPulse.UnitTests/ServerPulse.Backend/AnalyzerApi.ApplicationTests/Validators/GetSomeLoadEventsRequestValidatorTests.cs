...
namespace AnalyzerApi.Application.Validators.Tests
{
    ...
    internal class GetSomeLoadEventsRequestValidatorTests
    {
        ...
        public void Setup()
        {
            ...
            validator = new GetSomeLoadEventsRequestValidator(mockConfiguration.Object);
        }
        ...
        {
            // Arrange
            var request = new GetSomeLoadEventsRequest { Key = key, NumberOfMessages = 50, StartDate = DateTime.UtcNow };
        ...
        {
            // Arrange
            var request = new GetSomeLoadEventsRequest { Key = "ValidKey", NumberOfMessages = numberOfMessages, StartDate = DateTime.UtcNow };

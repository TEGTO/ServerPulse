...
namespace AnalyzerApi.Application.Validators.Tests
{
    [TestFixture]
    internal class GetLoadAmountStatisticsInRangeRequestValidatorTests
    {
        private GetLoadAmountStatisticsInRangeRequestValidator validator;
        ...
        public void Setup()
        {
            ...
            mockConfiguration.Setup(c => c[ConfigurationKeys.MIN_STATISTICS_TIMESPAN_IN_SECONDS]).Returns("60");

            validator = new GetLoadAmountStatisticsInRangeRequestValidator(mockConfiguration.Object);
        }

...
using AnalyzerApi.ApplicationTests;
...
using static AnalyzerApi.Application.Services.StatisticsDispatchers.LifecycleStatisticsDispatcher;

namespace AnalyzerApi.Application.Services.StatisticsDispatchers.Tests
{
    [TestFixture]

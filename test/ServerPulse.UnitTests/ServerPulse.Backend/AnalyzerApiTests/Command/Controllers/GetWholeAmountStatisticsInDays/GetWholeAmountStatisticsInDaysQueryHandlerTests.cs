...
namespace AnalyzerApi.Command.Controllers.GetWholeAmountStatisticsInDays.Tests
{
    [TestFixture]
    internal class GetWholeAmountStatisticsInDaysQueryHandlerTests
    {
        private Mock<ILoadAmountStatisticsReceiver> mockReceiver;
        private Mock<IMapper> mockMapper;
        private GetWholeAmountStatisticsInDaysQueryHandler handler;
        ...
        public void Setup()
        {
            ...
            handler = new GetWholeAmountStatisticsInDaysQueryHandler(mockReceiver.Object, mockMapper.Object);
        }
        ...
        public async Task Handle_ValidQuery_ReturnsMappedResponse()
        {
            // Arrange
            var key = "testKey";
            var query = new GetWholeAmountStatisticsInDaysQuery(key);

...
namespace AnalyzerApi.Command.Controllers.GetAmountStatisticsInRange.Tests
{
    [TestFixture]
    internal class GetAmountStatisticsInRangeQueryHandlerTests
    {
        private Mock<ILoadAmountStatisticsReceiver> mockReceiver;
        private Mock<IMapper> mockMapper;
        private GetAmountStatisticsInRangeQueryHandler handler;
        ...
        public void Setup()
        {
            ...
            handler = new GetAmountStatisticsInRangeQueryHandler(mockReceiver.Object, mockMapper.Object);
        }
        ...
        public async Task Handle_ValidQuery_ReturnsMappedResponses()
        {
            ...
            var query = new GetAmountStatisticsInRangeQuery(request);

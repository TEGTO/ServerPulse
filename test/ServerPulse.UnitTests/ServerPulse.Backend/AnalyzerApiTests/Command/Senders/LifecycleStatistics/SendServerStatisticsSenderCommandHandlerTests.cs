...
{
    [TestFixture]
    internal class SendServerStatisticsSenderCommandHandlerTests
    {
        ...
        public async Task Handle_ValidCommand_SendsToKafkaAndGroup()
        {
            ...
            // Act
            await handler.Handle(new SendServerStatisticsSenderCommand(key, statistics), CancellationToken.None);

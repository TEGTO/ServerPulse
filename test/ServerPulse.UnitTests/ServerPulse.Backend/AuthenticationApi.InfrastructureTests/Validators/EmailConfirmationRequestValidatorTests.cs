...
{
    [TestFixture]
    internal class EmailConfirmationRequestValidatorTests
    {
        private EmailConfirmationRequestValidator validator;

        [SetUp]
        public void SetUp()
        {
            validator = new EmailConfirmationRequestValidator();
        }

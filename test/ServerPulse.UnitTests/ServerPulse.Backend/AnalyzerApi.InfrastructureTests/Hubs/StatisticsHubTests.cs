...
namespace AnalyzerApi.Infrastructure.Hubs.Tests
{
    [TestFixture]
    internal class StatisticsHubTests
    {
        private Mock<IStatisticsDispatcher<TestStatistics>> mockStatisticsDispatcher;
        private Mock<ILogger<StatisticsHub<TestStatistics, TestStatisticsResponse>>> mockLogger;
        private Mock<HubCallerContext> mockContext;
        private Mock<IGroupManager> mockGroups;
        private StatisticsHub<TestStatistics, TestStatisticsResponse> statisticsHub;

        [SetUp]
        public void Setup()
        {
            mockStatisticsDispatcher = new Mock<IStatisticsDispatcher<TestStatistics>>();
            mockLogger = new Mock<ILogger<StatisticsHub<TestStatistics, TestStatisticsResponse>>>();
            mockContext = new Mock<HubCallerContext>();
            mockGroups = new Mock<IGroupManager>();

            statisticsHub = new StatisticsHub<TestStatistics, TestStatisticsResponse>(mockStatisticsDispatcher.Object, mockLogger.Object)
            {

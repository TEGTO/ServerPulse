...
{
    internal class GetSlotsByEmailControllerTests : BaseServerSlotControllerTest
    {
        [Test]
        public async Task GetSlotsByEmail_ReturnsOkWithServerSlots()
        {
            ...
            var response = JsonSerializer.Deserialize<List<GetSlotsByEmailResponse>>(content, new JsonSerializerOptions
            {
        ...
        public async Task GetSlotsByEmail_ReturnsServerSlotsCachedByUser()
        {
            ...
            await CreateSampleSlot(new CreateSlotRequest { Name = "NewSlot" }, anotherAccessToken);
            ...
            var response2 = JsonSerializer.Deserialize<List<GetSlotsByEmailResponse>>(content2, new JsonSerializerOptions
            {
                PropertyNameCaseInsensitive = true
            });

            var content3 = await httpResponse3.Content.ReadAsStringAsync();
            var response3 = JsonSerializer.Deserialize<List<GetSlotsByEmailResponse>>(content3, new JsonSerializerOptions
            {
                PropertyNameCaseInsensitive = true
            });
        ...
        public async Task GetSlotsByEmail_ProvidedIncludeString_ReturnsOkWithTwoServerSlots()
        {
            ...
            var content = await httpResponse.Content.ReadAsStringAsync();
            var actualServerSlots = JsonSerializer.Deserialize<List<GetSlotsByEmailResponse>>(content, new JsonSerializerOptions
            {
                PropertyNameCaseInsensitive = true
            });
        ...
        public async Task GetSlotsByEmail__ProvidedIncludeString_ReturnsServerSlotsCachedByUser()
        {
            ...
            await CreateSampleSlot(new CreateSlotRequest { Name = "Slot1New" }, anotherAccessToken);

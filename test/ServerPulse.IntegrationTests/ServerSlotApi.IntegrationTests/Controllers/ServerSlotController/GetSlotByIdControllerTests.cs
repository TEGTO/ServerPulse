...
{
    internal class GetSlotByIdControllerTests : BaseServerSlotControllerTest
    {
        [Test]
        public async Task GetSlotById_ValidId_ReturnsOKWithItem()
        {
            ...
            var actualServerSlot = JsonSerializer.Deserialize<GetSlotByIdResponse>(content, new JsonSerializerOptions
            {

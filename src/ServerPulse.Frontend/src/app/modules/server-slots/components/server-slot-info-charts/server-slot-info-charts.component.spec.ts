...
describe('ServerSlotInfoChartsComponent', () => {
  ...
  it('should fetch control statistics on initialization', () => {
    ...
    mockStatisticsService.getWholeAmountStatisticsInDays.and.returnValue(of(mockStatistics));
    mockStatisticsService.getAmountStatisticsInRange.and.returnValue(of(mockStatistics));
    mockStatisticsService.getLastServerLoadStatistics.and.returnValue(of(mockServerStatistics));

    component.ngAfterViewInit();

    expect(mockStatisticsService.getWholeAmountStatisticsInDays).toHaveBeenCalledWith('test-slot-key');
    expect(mockStatisticsService.getAmountStatisticsInRange).toHaveBeenCalled();
